...
/*   Updated: 2021/01/21 20:50:09 by ssnowbir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(void)
{
	...
	std::cout<<this->_name<< ":" <<"Just tell me what to shoot."  <<std::endl;
	return ;
}

ScavTrap & ScavTrap::operator=(ScavTrap const &src)
{
	std::cout<<this->_name<< ":" <<"Hi, my clone."  <<std::endl;
...
{
	std::cout<< this->_name<< ":"<< "Excellent." << std::endl;
	*this = src;
}
...
void 		ScavTrap::rangedAttack(std::string const & target)
{
	if (this->_hit_points == 0)
		...
		std::cout <<this->_name<< ":" << "Munitions dry." << std::endl;
	else if (this->_energy_points - this->_ranged_attack_damage > 0)
	{
		std::cout<<this->_name<< ":" << "I'm covered in slag!.I must seek cover quickly or pain is coming" << std::endl;
...
void 		ScavTrap::meleeAttack(std::string const & target)
{
	if (this->_hit_points == 0)
		...
		std::cout<<this->_name<< ":" << "Where is my bullets?!?!?!" << std::endl;
	else if (this->_energy_points - this->_melee_attack_damage > 0)
	{
		std::cout<<this->_name<< ":" << "Yoo-hoo, stupid guy...You're powerless!" << std::endl;
...
void		ScavTrap::rand_attack(int i)
{
	switch (i)
	{
		case 0:
		{
			std::cout<<this->_name<< ":" <<"Burst Combat!"<<std::endl;
			std::cout<<this->_name<< ":" << "it's crushing!" << std::endl;
		}
		case 1:
		{
			std::cout<<this->_name<< ":" <<"Big Pistol!"<<std::endl;
			std::cout<<this->_name<< ":" << "it's crushing!" << std::endl;
		}
		case 2:
		{
			std::cout<<this->_name<< ":" <<"Repeater!"<<std::endl;
			std::cout<<this->_name<< ":" << "it's crushing!" << std::endl;
		}
		case 3:
		{
			std::cout<<this->_name<< ":" <<"Revolver"<<std::endl;
			std::cout<<this->_name<< ":" << "it's crushing!" << std::endl;
		}
		case 4:
		{
			std::cout<<this->_name<< ":" <<"Rocket Launcher"<<std::endl;
			std::cout<<this->_name<< ":" << "it's crushing!" << std::endl;
		}
	}
}
