...
/*   Updated: 2021/01/21 20:44:32 by ssnowbir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(void)
{
	...
	std::cout <<this->_name<< ":" <<"Let me teach you the ways of magic!"  <<std::endl;
	return ;
}
...
void 		FragTrap::rangedAttack(std::string const & target)
{
	if (this->_hit_points == 0)
		...
		std::cout <<this->_name<< ":" << "I'm out of ammo!" << std::endl;
	else if (this->_energy_points - this->_ranged_attack_damage > 0)
	{
		std::cout<<this->_name<< ":" << "What happened to you?.So strong, imposing, fearsome.Oh yeah, I am killing you." << std::endl;
...
void 		FragTrap::meleeAttack(std::string const & target)
{
	...
	{
		std::cout<<this->_name<< ":" << "You're powerless!" << std::endl;
